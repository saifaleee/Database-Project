<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddAttendence.aspx.cs" Inherits="DBProj.AddAttendence" %>
	...
	<div class="container">
		...
		<div class="complete-container">
			...
			<div class="table-layout">
				...
				<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Upload Attendence" />
			</div>
		</div>
		</div>
		</form>
